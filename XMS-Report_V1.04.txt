...
.DESCRIPTION
	Creates a XenMobile Configuration report using Microsoft Word, PDF, formatted 
	text, or HTML and PowerShell.
...
.EXAMPLE
	...
	-SmtpPort 587
	-UseSSL 
	-From Arnaud@ArnaudPain.com 
	-To ITGroup@ArnaudPain.com	
...
#	Webster: Change color variables $wdColorGray15 and $wdColorGray05 from [long] to [int]
...
#	Webster: Reordered the parameters
...
#	Webster: Update Function SetWordCellFormat to change parameter $BackgroundColor to [int]
#	Webster: Update Functions ShowScriptOptions and ProcessScriptEnd for Log parameter
...
If($Log) 
{
	...
	$Script:LogPath = "$($Script:pwdpath)\XMS-ReportScriptTranscript_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
...
{
	$Error.Clear()
	$Script:DevErrorFile = "$($Script:pwdpath)\XMS-ReportScriptErrors_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
}
...
Function OutputSampleText
{
	If($MSWORD -or $PDF)
	{
		...
		WriteWordLine 0 0 ""
		WriteWordLine 0 0 ""
		WriteWordLine 0 0 "The current version of the script is 1.04, updates are planned to be implemented in the next few weeks."
		WriteWordLine 0 0 ""
	...
	ElseIf($Text)
	{
		...
		Line 0 ""
		Line 0 ""
		Line 0 "The current version of the script is 1.04, updates are planned to be implemented in the next few weeks."
		Line 0 ""
	...
	ElseIf($HTML)
	{
		...
		WriteHTMLLine 0 0 ""
		WriteHTMLLine 0 0 ""
		WriteHTMLLine 0 0 "The current version of the script is 1.04, updates are planned to be implemented in the next few weeks."
		WriteHTMLLine 0 0 ""
...
Function ConnectXMS
{
	...
	$Global:XMS = Read-Host -Prompt 'Please provide the FQDN of the XMS Server'
...
Function ProcessScriptEnd
{
	...
	If($ScriptInfo)
	{
		$SIFile = "$($Script:pwdPath)\XMS-TemplateInfo_$(Get-Date -f yyyy-MM-dd_HHmm).txt"
